@include('template.header') 
    ...
    <form class="form-signin text-left" method="post" action="{{ route('companylogin') }}">
    @csrf
        ...
        <label>Dont't have a company account? <a href="{{ route('companyregister') }}">click to register</a></label>
    </form> 
    </main>
